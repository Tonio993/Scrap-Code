package grafica.objects.animatedObject.animationHandler;

import java.util.HashMap;
import java.util.TreeSet;

import grafica.objects.animatedObject.IAObjects;
...
public class AnimationHandlerImpl implements AnimationHandler {
	...
	public boolean addAnimatedObject(ImageAnimatedObject imageAnimatedObject) {
		Util.checkNull(imageAnimatedObject);
